package top.hondaman.manux.module.system.service.social;
...
import top.hondaman.manux.framework.common.util.cache.CacheUtils;
import top.hondaman.manux.framework.common.util.http.HttpUtils;
import top.hondaman.manux.framework.common.util.object.BeanUtils;
import top.hondaman.manux.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import top.hondaman.manux.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import top.hondaman.manux.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import top.hondaman.manux.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import top.hondaman.manux.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import top.hondaman.manux.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import top.hondaman.manux.module.system.dal.dataobject.social.SocialClientDO;
import top.hondaman.manux.module.system.dal.mysql.social.SocialClientMapper;
import top.hondaman.manux.module.system.dal.redis.RedisKeyConstants;
import top.hondaman.manux.module.system.enums.social.SocialTypeEnum;
import top.hondaman.manux.module.system.framework.justauth.core.AuthRequestFactory;
...
import static top.hondaman.manux.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static top.hondaman.manux.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${manux.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${manux.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/manux-cloud/pulls/230
