package top.hondaman.manux.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import top.hondaman.manux.framework.common.enums.CommonStatusEnum;
import top.hondaman.manux.framework.common.exception.ServiceException;
import top.hondaman.manux.framework.common.pojo.CommonResult;
import top.hondaman.manux.framework.common.pojo.PageResult;
import top.hondaman.manux.framework.common.util.collection.ArrayUtils;
import top.hondaman.manux.framework.common.util.collection.CollectionUtils;
import top.hondaman.manux.framework.test.core.ut.BaseDbUnitTest;
import top.hondaman.manux.module.infra.api.config.ConfigApi;
import top.hondaman.manux.module.infra.api.file.FileApi;
import top.hondaman.manux.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import top.hondaman.manux.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import top.hondaman.manux.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import top.hondaman.manux.module.system.controller.admin.user.vo.user.UserImportRespVO;
import top.hondaman.manux.module.system.controller.admin.user.vo.user.UserPageReqVO;
import top.hondaman.manux.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import top.hondaman.manux.module.system.dal.dataobject.dept.DeptDO;
import top.hondaman.manux.module.system.dal.dataobject.dept.PostDO;
import top.hondaman.manux.module.system.dal.dataobject.dept.UserPostDO;
import top.hondaman.manux.module.system.dal.dataobject.tenant.TenantDO;
import top.hondaman.manux.module.system.dal.dataobject.user.AdminUserDO;
import top.hondaman.manux.module.system.dal.mysql.dept.UserPostMapper;
import top.hondaman.manux.module.system.dal.mysql.user.AdminUserMapper;
import top.hondaman.manux.module.system.enums.common.SexEnum;
import top.hondaman.manux.module.system.service.dept.DeptService;
import top.hondaman.manux.module.system.service.dept.PostService;
import top.hondaman.manux.module.system.service.oauth2.OAuth2TokenService;
import top.hondaman.manux.module.system.service.permission.PermissionService;
import top.hondaman.manux.module.system.service.tenant.TenantService;
...
import static top.hondaman.manux.framework.common.util.collection.SetUtils.asSet;
import static top.hondaman.manux.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static top.hondaman.manux.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static top.hondaman.manux.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static top.hondaman.manux.framework.test.core.util.AssertUtils.assertPojoEquals;
import static top.hondaman.manux.framework.test.core.util.AssertUtils.assertServiceException;
import static top.hondaman.manux.framework.test.core.util.RandomUtils.*;
import static top.hondaman.manux.module.system.enums.ErrorCodeConstants.*;
import static top.hondaman.manux.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn(success("manuxyuanma"));
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("manuxyuanma");
        ...
        assertEquals("manuxyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("manuxyuanma"))).thenReturn("java");
