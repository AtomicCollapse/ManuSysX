...
public interface GroupMemberService extends IService<GroupMemberDO> {
     ...
     * @return 群聊成员信息
     */
    GroupMemberDO findByGroupAndUserId(Long groupId, Long userId);
     ...
     * @return 成员列表
     */
    List<GroupMemberDO> findByUserId(Long userId);
     ...
     * @return 成员列表
     */
    List<GroupMemberDO> findQuitInMonth(Long userId);
     ...
     * @return 群聊成员列表
     */
    List<GroupMemberDO> findByGroupId(Long groupId);
     ...
     * @return 成功或失败
     */
    boolean saveOrUpdateBatch(Long groupId, List<GroupMemberDO> members);
