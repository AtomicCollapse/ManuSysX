package top.hondaman.manux.module.promotion.service.article;

import cn.hutool.core.collection.CollUtil;
import top.hondaman.manux.framework.common.pojo.PageResult;
import top.hondaman.manux.module.promotion.controller.admin.article.vo.article.ArticleCreateReqVO;
import top.hondaman.manux.module.promotion.controller.admin.article.vo.article.ArticlePageReqVO;
import top.hondaman.manux.module.promotion.controller.admin.article.vo.article.ArticleUpdateReqVO;
import top.hondaman.manux.module.promotion.controller.app.article.vo.article.AppArticlePageReqVO;
import top.hondaman.manux.module.promotion.convert.article.ArticleConvert;
import top.hondaman.manux.module.promotion.dal.dataobject.article.ArticleCategoryDO;
import top.hondaman.manux.module.promotion.dal.dataobject.article.ArticleDO;
import top.hondaman.manux.module.promotion.dal.mysql.article.ArticleMapper;
...
import static top.hondaman.manux.module.promotion.enums.ErrorCodeConstants.ARTICLE_CATEGORY_NOT_EXISTS;
import static top.hondaman.manux.module.promotion.enums.ErrorCodeConstants.ARTICLE_NOT_EXISTS;
