package top.hondaman.manux.module.promotion.service.combination;
...
import top.hondaman.manux.module.promotion.api.combination.dto.CombinationValidateJoinRespDTO;
import top.hondaman.manux.module.promotion.controller.admin.combination.vo.recrod.CombinationRecordReqPageVO;
import top.hondaman.manux.module.promotion.controller.app.combination.vo.record.AppCombinationRecordPageReqVO;
import top.hondaman.manux.module.promotion.convert.combination.CombinationActivityConvert;
...
import top.hondaman.manux.module.promotion.dal.mysql.combination.CombinationRecordMapper;
...
import top.hondaman.manux.module.trade.enums.order.TradeOrderCancelTypeEnum;
...
import static top.hondaman.manux.framework.common.util.date.LocalDateTimeUtils.afterNow;
import static top.hondaman.manux.framework.common.util.date.LocalDateTimeUtils.beforeNow;
import static top.hondaman.manux.module.promotion.enums.ErrorCodeConstants.*;
import static top.hondaman.manux.module.promotion.enums.MessageTemplateConstants.COMBINATION_SUCCESS;
