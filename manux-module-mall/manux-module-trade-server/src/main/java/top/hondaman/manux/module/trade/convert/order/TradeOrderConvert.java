...
import top.hondaman.manux.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import top.hondaman.manux.module.product.api.sku.dto.ProductSkuRespDTO;
import top.hondaman.manux.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
...
import top.hondaman.manux.module.trade.api.order.dto.TradeOrderRespDTO;
import top.hondaman.manux.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import top.hondaman.manux.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import top.hondaman.manux.module.trade.controller.admin.order.vo.*;
import top.hondaman.manux.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import top.hondaman.manux.module.trade.controller.app.order.vo.*;
import top.hondaman.manux.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import top.hondaman.manux.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import top.hondaman.manux.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import top.hondaman.manux.module.trade.framework.order.config.TradeOrderProperties;
import top.hondaman.manux.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static top.hondaman.manux.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/manuxcode/manux-mall-uniapp/issues/ICY7SJ
