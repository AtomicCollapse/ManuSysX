package top.hondaman.manux.module.erp.dal.dataobject.sale;
...
public class ErpSaleOutDO extends BaseDO {
     ...
     * 已收款金额，单位：元
     *
     * 目的：和 {@link top.hondaman.manux.module.erp.dal.dataobject.finance.ErpFinanceReceiptDO} 结合，记录已收款金额
     */
