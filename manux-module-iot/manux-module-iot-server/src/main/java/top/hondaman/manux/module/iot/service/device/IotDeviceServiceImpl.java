package top.hondaman.manux.module.iot.service.device;
...
import top.hondaman.manux.framework.common.util.validation.ValidationUtils;
...
import top.hondaman.manux.module.iot.controller.admin.device.vo.device.*;
import top.hondaman.manux.module.iot.core.biz.dto.IotDeviceAuthReqDTO;
import top.hondaman.manux.module.iot.core.biz.dto.IotSubDeviceRegisterFullReqDTO;
import top.hondaman.manux.module.iot.core.enums.IotDeviceMessageMethodEnum;
import top.hondaman.manux.module.iot.core.enums.device.IotDeviceStateEnum;
...
import top.hondaman.manux.module.iot.core.topic.auth.IotDeviceRegisterReqDTO;
import top.hondaman.manux.module.iot.core.topic.auth.IotDeviceRegisterRespDTO;
import top.hondaman.manux.module.iot.core.topic.auth.IotSubDeviceRegisterReqDTO;
import top.hondaman.manux.module.iot.core.topic.auth.IotSubDeviceRegisterRespDTO;
import top.hondaman.manux.module.iot.core.topic.topo.IotDeviceTopoAddReqDTO;
import top.hondaman.manux.module.iot.core.topic.topo.IotDeviceTopoChangeReqDTO;
import top.hondaman.manux.module.iot.core.topic.topo.IotDeviceTopoDeleteReqDTO;
import top.hondaman.manux.module.iot.core.topic.topo.IotDeviceTopoGetRespDTO;
import top.hondaman.manux.module.iot.core.util.IotDeviceAuthUtils;
import top.hondaman.manux.module.iot.core.util.IotProductAuthUtils;
import top.hondaman.manux.module.iot.dal.dataobject.device.IotDeviceDO;
import top.hondaman.manux.module.iot.dal.dataobject.device.IotDeviceGroupDO;
import top.hondaman.manux.module.iot.dal.dataobject.product.IotProductDO;
import top.hondaman.manux.module.iot.dal.mysql.device.IotDeviceMapper;
import top.hondaman.manux.module.iot.dal.redis.RedisKeyConstants;
import top.hondaman.manux.module.iot.enums.product.IotProductDeviceTypeEnum;
import top.hondaman.manux.module.iot.service.device.message.IotDeviceMessageService;
import top.hondaman.manux.module.iot.service.product.IotProductService;
...
import static top.hondaman.manux.module.iot.enums.ErrorCodeConstants.*;
