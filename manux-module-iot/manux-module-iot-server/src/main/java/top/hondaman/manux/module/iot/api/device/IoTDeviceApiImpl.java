package top.hondaman.manux.module.iot.api.device;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.ObjUtil;
import cn.hutool.core.util.StrUtil;
import top.hondaman.manux.framework.common.enums.RpcConstants;
...
import top.hondaman.manux.module.iot.core.biz.dto.*;
...
import top.hondaman.manux.module.iot.dal.dataobject.device.IotDeviceModbusPointDO;
...
import top.hondaman.manux.module.iot.service.device.IotDeviceModbusPointService;
...
@RestController
@Validated
@Primary // 保证优先匹配，因为 manux-iot-gateway 也有 IotDeviceCommonApi 的实现，并且也可能会被 biz 引入
