package top.hondaman.manux.module.iot.job.device;

import cn.hutool.core.collection.CollUtil;
import top.hondaman.manux.framework.common.util.json.JsonUtils;
import top.hondaman.manux.framework.tenant.core.job.TenantJob;
...
import top.hondaman.manux.module.iot.framework.iot.config.ManuxIotProperties;
...
public class IotDeviceOfflineCheckJob {
    ...
    @Resource
    private ManuxIotProperties iotProperties;
