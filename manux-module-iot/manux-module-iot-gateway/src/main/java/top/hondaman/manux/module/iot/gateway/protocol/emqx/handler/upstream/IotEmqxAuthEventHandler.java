package top.hondaman.manux.module.iot.gateway.protocol.emqx.handler.upstream;
...
import top.hondaman.manux.module.iot.gateway.protocol.emqx.IotEmqxProtocol;
    ...
    private void sendRegisterResultMessage(String username, IotDeviceRegisterRespDTO result) {
        ...
        try {
            ...
            byte[] encodedData = deviceMessageService.serializeDeviceMessage(responseMessage,
                    top.hondaman.manux.module.iot.core.enums.IotSerializeTypeEnum.JSON);
            // 1.3 构建响应主题
