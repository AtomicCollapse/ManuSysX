package top.hondaman.manux.module.iot.gateway.protocol.modbus.tcpserver.handler.upstream;
...
import top.hondaman.manux.framework.common.exception.enums.GlobalErrorCodeConstants;
...
import top.hondaman.manux.module.iot.core.biz.IotDeviceCommonApi;
import top.hondaman.manux.module.iot.core.biz.dto.IotDeviceAuthReqDTO;
import top.hondaman.manux.module.iot.core.biz.dto.IotDeviceRespDTO;
import top.hondaman.manux.module.iot.core.biz.dto.IotModbusDeviceConfigRespDTO;
import top.hondaman.manux.module.iot.core.biz.dto.IotModbusPointRespDTO;
import top.hondaman.manux.module.iot.core.enums.IotDeviceMessageMethodEnum;
import top.hondaman.manux.module.iot.core.enums.modbus.IotModbusFrameFormatEnum;
import top.hondaman.manux.module.iot.core.mq.message.IotDeviceMessage;
import top.hondaman.manux.module.iot.core.topic.IotDeviceIdentity;
import top.hondaman.manux.module.iot.core.util.IotDeviceAuthUtils;
import top.hondaman.manux.module.iot.gateway.protocol.modbus.common.utils.IotModbusCommonUtils;
import top.hondaman.manux.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrame;
import top.hondaman.manux.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrameEncoder;
import top.hondaman.manux.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConfigCacheService;
import top.hondaman.manux.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager;
import top.hondaman.manux.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager.ConnectionInfo;
import top.hondaman.manux.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager;
import top.hondaman.manux.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager.PendingRequest;
import top.hondaman.manux.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPollScheduler;
import top.hondaman.manux.module.iot.gateway.service.device.IotDeviceService;
import top.hondaman.manux.module.iot.gateway.service.device.message.IotDeviceMessageService;
import io.vertx.core.net.NetSocket;
import lombok.extern.slf4j.Slf4j;

import java.util.Map;

import static top.hondaman.manux.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static top.hondaman.manux.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static top.hondaman.manux.framework.common.exception.util.ServiceExceptionUtil.invalidParamException;
...
public class IotModbusTcpServerUpstreamHandler {
     ...
     * 处理自定义功能码帧
     * <p>
     * 异常分层翻译，参考 {@link top.hondaman.manux.module.iot.gateway.protocol.http.handler.upstream.IotHttpAbstractHandler}
     */
