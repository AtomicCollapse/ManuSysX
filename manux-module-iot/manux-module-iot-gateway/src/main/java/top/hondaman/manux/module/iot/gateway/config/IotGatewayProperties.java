package top.hondaman.manux.module.iot.gateway.config;

import top.hondaman.manux.module.iot.core.enums.IotProtocolTypeEnum;
import top.hondaman.manux.module.iot.gateway.protocol.coap.IotCoapConfig;
import top.hondaman.manux.module.iot.gateway.protocol.emqx.IotEmqxConfig;
import top.hondaman.manux.module.iot.gateway.protocol.http.IotHttpConfig;
import top.hondaman.manux.module.iot.gateway.protocol.modbus.tcpclient.IotModbusTcpClientConfig;
import top.hondaman.manux.module.iot.gateway.protocol.modbus.tcpserver.IotModbusTcpServerConfig;
import top.hondaman.manux.module.iot.gateway.protocol.mqtt.IotMqttConfig;
import top.hondaman.manux.module.iot.gateway.protocol.tcp.IotTcpConfig;
import top.hondaman.manux.module.iot.gateway.protocol.udp.IotUdpConfig;
import top.hondaman.manux.module.iot.gateway.protocol.websocket.IotWebSocketConfig;
...
@ConfigurationProperties(prefix = "manux.iot.gateway")
@Validated
@Data
public class IotGatewayProperties {
    ...
    public static class ProtocolProperties {
         ...
         * 协议类型
         *
         * @see top.hondaman.manux.module.iot.core.enums.IotProtocolTypeEnum
         */
         ...
         * 序列化类型（可选）
         *
         * @see top.hondaman.manux.module.iot.core.enums.IotSerializeTypeEnum
         *
         * 为什么是可选的呢？
