package top.hondaman.manux.module.iot.gateway.protocol.tcp;
...
import top.hondaman.manux.module.iot.core.topic.topo.IotDeviceTopoGetReqDTO;
import top.hondaman.manux.module.iot.core.util.IotDeviceAuthUtils;
import top.hondaman.manux.module.iot.gateway.protocol.tcp.codec.IotTcpCodecTypeEnum;
import top.hondaman.manux.module.iot.gateway.protocol.tcp.codec.IotTcpFrameCodec;
import top.hondaman.manux.module.iot.gateway.protocol.tcp.codec.IotTcpFrameCodecFactory;
import top.hondaman.manux.module.iot.gateway.serialize.IotMessageSerializer;
import top.hondaman.manux.module.iot.gateway.serialize.json.IotJsonSerializer;
 ...
 * <p>使用步骤：
 * <ol>
 *     <li>启动 manux-module-iot-gateway 服务（TCP 端口 8091）</li>
 *     <li>运行以下测试方法：
 *         <ul>
