package top.hondaman.manux.framework.tracer.config;

import top.hondaman.manux.framework.common.enums.WebFilterOrderEnum;
import top.hondaman.manux.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "manux.tracer", value = "enable", matchIfMissing = true)
public class ManuxTracerAutoConfiguration {
