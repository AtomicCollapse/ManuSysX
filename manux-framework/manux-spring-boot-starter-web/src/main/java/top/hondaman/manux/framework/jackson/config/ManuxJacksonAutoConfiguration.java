package top.hondaman.manux.framework.jackson.config;

import top.hondaman.manux.framework.common.util.json.JsonUtils;
import top.hondaman.manux.framework.common.util.json.databind.NumberSerializer;
import top.hondaman.manux.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import top.hondaman.manux.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class ManuxJacksonAutoConfiguration {
