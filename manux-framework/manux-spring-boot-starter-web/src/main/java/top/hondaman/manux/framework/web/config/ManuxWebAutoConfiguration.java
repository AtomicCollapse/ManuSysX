package top.hondaman.manux.framework.web.config;
...
import top.hondaman.manux.framework.web.core.filter.CacheRequestBodyFilter;
import top.hondaman.manux.framework.web.core.filter.DemoFilter;
import top.hondaman.manux.framework.web.core.handler.GlobalExceptionHandler;
import top.hondaman.manux.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class ManuxWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "manux.demo", havingValue = "true")
