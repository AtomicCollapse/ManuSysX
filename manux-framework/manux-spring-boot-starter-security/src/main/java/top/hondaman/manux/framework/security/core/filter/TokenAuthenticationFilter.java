package top.hondaman.manux.framework.security.core.filter;
    ...
    private LoginUser buildLoginUserByToken(String token, Integer userType) {
        try {
            ...
            return new LoginUser().setId(accessToken.getUserId()).setUserType(accessToken.getUserType())
                    ...
                    .setExpiresTime(accessToken.getExpiresTime()).setImUserId(accessToken.getImUserId()).setTerminal(accessToken.getTerminal());
