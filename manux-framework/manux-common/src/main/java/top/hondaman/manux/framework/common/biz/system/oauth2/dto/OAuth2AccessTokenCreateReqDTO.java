package top.hondaman.manux.framework.common.biz.system.oauth2.dto;
...
public class OAuth2AccessTokenCreateReqDTO implements Serializable {
    ...
    @Schema(description = "客户端编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "manuxyuanma")
