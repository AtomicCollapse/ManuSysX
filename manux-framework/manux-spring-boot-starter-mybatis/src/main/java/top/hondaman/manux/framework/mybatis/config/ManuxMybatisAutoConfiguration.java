package top.hondaman.manux.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import top.hondaman.manux.framework.common.util.json.JsonUtils;
import top.hondaman.manux.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${manux.info.base-package}", annotationClass = Mapper.class,
        lazyInitialization = "${mybatis.lazy-initialization:false}") // Mapper 懒加载，目前仅用于单元测试
public class ManuxMybatisAutoConfiguration {
