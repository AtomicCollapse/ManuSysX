package top.hondaman.manux.framework.tenant.config;

import cn.hutool.extra.spring.SpringUtil;
import top.hondaman.manux.framework.common.biz.system.tenant.TenantCommonApi;
...
import top.hondaman.manux.framework.redis.config.ManuxCacheProperties;
import top.hondaman.manux.framework.security.core.service.SecurityFrameworkService;
import top.hondaman.manux.framework.tenant.core.aop.TenantIgnore;
import top.hondaman.manux.framework.tenant.core.aop.TenantIgnoreAspect;
import top.hondaman.manux.framework.tenant.core.db.TenantDatabaseInterceptor;
import top.hondaman.manux.framework.tenant.core.job.TenantJobAspect;
import top.hondaman.manux.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import top.hondaman.manux.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import top.hondaman.manux.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import top.hondaman.manux.framework.tenant.core.redis.TenantRedisCacheManager;
import top.hondaman.manux.framework.tenant.core.security.TenantSecurityWebFilter;
import top.hondaman.manux.framework.tenant.core.service.TenantFrameworkService;
import top.hondaman.manux.framework.tenant.core.service.TenantFrameworkServiceImpl;
import top.hondaman.manux.framework.tenant.core.web.TenantContextWebFilter;
import top.hondaman.manux.framework.tenant.core.web.TenantVisitContextInterceptor;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "manux.tenant", value = "enable", matchIfMissing = true) // 允许使用 manux.tenant.enable=false 禁用多租户
@EnableConfigurationProperties(TenantProperties.class)
public class ManuxTenantAutoConfiguration {
    ...
    public TenantFrameworkService tenantFrameworkService(TenantCommonApi tenantApi) {
        // 参见 https://gitee.com/zhijiantianya/manux-cloud/issues/IC6YZF
        try {
     ...
     */
    @Configuration
    @ConditionalOnClass(name = "top.hondaman.manux.framework.mq.redis.core.RedisMQTemplate")
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     ManuxCacheProperties manuxCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(manuxCacheProperties.getRedisScanBatchSize()));
