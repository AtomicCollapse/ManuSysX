package top.hondaman.manux.module.member.service.signin;
...
import top.hondaman.manux.module.member.controller.admin.signin.vo.record.MemberSignInRecordPageReqVO;
import top.hondaman.manux.module.member.controller.app.signin.vo.record.AppMemberSignInRecordSummaryRespVO;
import top.hondaman.manux.module.member.convert.signin.MemberSignInRecordConvert;
import top.hondaman.manux.module.member.dal.dataobject.signin.MemberSignInConfigDO;
import top.hondaman.manux.module.member.dal.dataobject.signin.MemberSignInRecordDO;
import top.hondaman.manux.module.member.dal.dataobject.user.MemberUserDO;
import top.hondaman.manux.module.member.dal.mysql.signin.MemberSignInRecordMapper;
import top.hondaman.manux.module.member.enums.MemberExperienceBizTypeEnum;
import top.hondaman.manux.module.member.enums.point.MemberPointBizTypeEnum;
import top.hondaman.manux.module.member.service.level.MemberLevelService;
import top.hondaman.manux.module.member.service.point.MemberPointRecordService;
...
import static top.hondaman.manux.module.member.enums.ErrorCodeConstants.SIGN_IN_RECORD_TODAY_EXISTS;
