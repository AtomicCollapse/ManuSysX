package top.hondaman.manux.module.infra.service.logger;
...
import top.hondaman.manux.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import top.hondaman.manux.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import top.hondaman.manux.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import top.hondaman.manux.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static top.hondaman.manux.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static top.hondaman.manux.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("manux-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("manux-test");
