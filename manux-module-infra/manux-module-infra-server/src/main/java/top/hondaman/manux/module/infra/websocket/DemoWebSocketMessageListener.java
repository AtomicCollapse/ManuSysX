package top.hondaman.manux.module.infra.websocket;
...
import top.hondaman.manux.framework.websocket.core.sender.WebSocketMessageSender;
import top.hondaman.manux.framework.websocket.core.util.WebSocketFrameworkUtils;
import top.hondaman.manux.module.infra.websocket.message.DemoReceiveMessage;
import top.hondaman.manux.module.infra.websocket.message.DemoSendMessage;
...
public class DemoWebSocketMessageListener implements WebSocketMessageListener<DemoSendMessage> {
    ...
    @Autowired(required = false) // 由于 manux.websocket.enable 配置项，可以关闭 WebSocket 的功能，所以这里只能不强制注入
