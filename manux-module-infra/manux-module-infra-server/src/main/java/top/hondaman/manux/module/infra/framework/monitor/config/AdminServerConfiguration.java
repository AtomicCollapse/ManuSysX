package top.hondaman.manux.module.infra.framework.monitor.config;
 ...
 * 安全配置独立于 {@link top.hondaman.manux.framework.security.config.ManuxWebSecurityConfigurerAdapter}，
