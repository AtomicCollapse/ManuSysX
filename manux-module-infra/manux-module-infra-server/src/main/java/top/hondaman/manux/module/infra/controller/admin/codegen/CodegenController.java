package top.hondaman.manux.module.infra.controller.admin.codegen;
...
import top.hondaman.manux.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import top.hondaman.manux.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import top.hondaman.manux.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import top.hondaman.manux.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import top.hondaman.manux.module.infra.convert.codegen.CodegenConvert;
...
import top.hondaman.manux.module.infra.service.codegen.CodegenService;
...
import static top.hondaman.manux.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static top.hondaman.manux.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "manux"),
