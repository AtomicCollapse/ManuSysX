package top.hondaman.manux.module.infra.dal.dataobject.logger;
...
public class ApiErrorLogDO extends BaseDO {
     ...
     * 处理用户编号
     *
     * 关联 top.hondaman.manux.adminserver.modules.system.dal.dataobject.user.SysUserDO.SysUserDO#getId()
     */
