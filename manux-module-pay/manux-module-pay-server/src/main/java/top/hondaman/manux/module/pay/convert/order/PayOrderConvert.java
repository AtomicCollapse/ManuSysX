package top.hondaman.manux.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, top.hondaman.manux.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
