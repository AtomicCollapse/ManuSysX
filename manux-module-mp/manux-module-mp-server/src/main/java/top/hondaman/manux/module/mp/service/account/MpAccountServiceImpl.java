package top.hondaman.manux.module.mp.service.account;
...
import top.hondaman.manux.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import top.hondaman.manux.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import top.hondaman.manux.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import top.hondaman.manux.module.mp.convert.account.MpAccountConvert;
import top.hondaman.manux.module.mp.dal.dataobject.account.MpAccountDO;
import top.hondaman.manux.module.mp.dal.mysql.account.MpAccountMapper;
import top.hondaman.manux.module.mp.enums.ErrorCodeConstants;
...
import static top.hondaman.manux.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 manux-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
