...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "top.hondaman.manux";
    private static final String ARTIFACT_ID = "manux";
    private static final String PACKAGE_NAME = "top.hondaman.manux";
    private static final String TITLE = "ManuSysX";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "top.hondaman.manux";
        String artifactIdNew = "manux";
        String packageNameNew = "top.hondaman.manux";
        String titleNew = "ManuSysX";
        String projectBaseDirNew = "D:\\Code\\ManuSysX-new"; // 一键改名后，“新”项目所在的目录
