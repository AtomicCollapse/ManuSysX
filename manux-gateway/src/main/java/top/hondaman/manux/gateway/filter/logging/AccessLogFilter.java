package top.hondaman.manux.gateway.filter.logging;

import cn.hutool.core.date.LocalDateTimeUtil;
import cn.hutool.core.map.MapUtil;
import cn.hutool.json.JSONUtil;
import top.hondaman.manux.framework.common.util.json.JsonUtils;
import top.hondaman.manux.gateway.util.SecurityFrameworkUtils;
import top.hondaman.manux.gateway.util.WebFrameworkUtils;
 ...
 * 网关的访问日志过滤器
 *
 * 从功能上，它类似 manux-spring-boot-starter-web 的 ApiAccessLogFilter 过滤器
 *
...
public class AccessLogFilter implements GlobalFilter, Ordered {
    ...
    private void writeAccessLog(AccessLog gatewayLog) {
        ...
        try {
            ...
            // 兜底处理，参见 https://gitee.com/zhijiantianya/manux-cloud/issues/IC9A70
