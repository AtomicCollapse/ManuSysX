...
CREATE TABLE "pms"."t_pms_comp" (
  "sid" varchar(36) COLLATE "pg_catalog"."default" NOT NULL DEFAULT gen_random_uuid(),
  ...
  CONSTRAINT "t_pms_comp_pkey" PRIMARY KEY ("sid")
)
;
...
COMMENT ON COLUMN "pms"."t_pms_comp"."sid" IS '主键';
...
CREATE TABLE "pms"."t_pms_dept" (
  ...
  CONSTRAINT "t_pms_dept_pkey" PRIMARY KEY ("sid")
)
;
...
COMMENT ON COLUMN "pms"."t_pms_dept"."sid" IS '主键';
...
CREATE TABLE "pms"."t_pms_role" (
  ...
  "type" varchar(1) COLLATE "pg_catalog"."default",
	"head_id" varchar(36) COLLATE "pg_catalog"."default",
  CONSTRAINT "t_pms_role_pkey" PRIMARY KEY ("sid")
)
;
...
COMMENT ON COLUMN "pms"."t_pms_role"."sid" IS '主键';
...
CREATE TABLE "pms"."t_pms_user" (
  ...
  CONSTRAINT "t_pms_user_pkey" PRIMARY KEY ("sid")
)
;
...
COMMENT ON COLUMN "pms"."t_pms_user"."sid" IS '主键';
...
CREATE TABLE "pms"."t_pms_function" (
  ...
  CONSTRAINT "t_pms_function_pkey" PRIMARY KEY ("sid")
)
;
...
COMMENT ON COLUMN "pms"."t_pms_function"."sid" IS '主键';
...
CREATE TABLE "pms"."t_pms_role_rel" (
  ...
  CONSTRAINT "t_pms_role_rel_pkey" PRIMARY KEY ("sid")
)
;
...
COMMENT ON COLUMN "pms"."t_pms_role_rel"."sid" IS '主键';
