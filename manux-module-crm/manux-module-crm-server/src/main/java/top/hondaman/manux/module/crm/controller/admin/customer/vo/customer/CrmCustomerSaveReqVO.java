package top.hondaman.manux.module.crm.controller.admin.customer.vo.customer;

import top.hondaman.manux.framework.common.validation.InEnum;
import top.hondaman.manux.framework.common.validation.Mobile;
import top.hondaman.manux.framework.common.validation.Telephone;
import top.hondaman.manux.framework.excel.core.annotations.DictFormat;
import top.hondaman.manux.module.crm.enums.customer.CrmCustomerLevelEnum;
import top.hondaman.manux.module.crm.framework.operatelog.core.CrmCustomerIndustryParseFunction;
import top.hondaman.manux.module.crm.framework.operatelog.core.CrmCustomerLevelParseFunction;
import top.hondaman.manux.module.crm.framework.operatelog.core.CrmCustomerSourceParseFunction;
import top.hondaman.manux.module.crm.framework.operatelog.core.SysAreaParseFunction;
...
import static top.hondaman.manux.module.crm.enums.DictTypeConstants.CRM_CUSTOMER_INDUSTRY;
