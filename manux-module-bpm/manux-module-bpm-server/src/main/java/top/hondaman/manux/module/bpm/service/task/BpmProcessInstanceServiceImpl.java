package top.hondaman.manux.module.bpm.service.task;
...
import top.hondaman.manux.framework.common.util.date.DateUtils;
import top.hondaman.manux.framework.common.util.json.JsonUtils;
import top.hondaman.manux.framework.common.util.object.ObjectUtils;
import top.hondaman.manux.framework.common.util.object.PageUtils;
import top.hondaman.manux.framework.datapermission.core.annotation.DataPermission;
import top.hondaman.manux.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import top.hondaman.manux.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import top.hondaman.manux.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import top.hondaman.manux.module.bpm.controller.admin.task.vo.instance.*;
import top.hondaman.manux.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import top.hondaman.manux.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import top.hondaman.manux.module.bpm.convert.task.BpmProcessInstanceConvert;
import top.hondaman.manux.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import top.hondaman.manux.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import top.hondaman.manux.module.bpm.enums.ErrorCodeConstants;
import top.hondaman.manux.module.bpm.enums.definition.BpmModelTypeEnum;
import top.hondaman.manux.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import top.hondaman.manux.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import top.hondaman.manux.module.bpm.enums.task.BpmReasonEnum;
import top.hondaman.manux.module.bpm.enums.task.BpmTaskStatusEnum;
import top.hondaman.manux.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import top.hondaman.manux.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import top.hondaman.manux.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import top.hondaman.manux.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import top.hondaman.manux.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import top.hondaman.manux.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import top.hondaman.manux.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import top.hondaman.manux.module.bpm.framework.flowable.core.util.FlowableUtils;
import top.hondaman.manux.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import top.hondaman.manux.module.bpm.service.definition.BpmProcessDefinitionService;
import top.hondaman.manux.module.bpm.service.message.BpmMessageService;
import top.hondaman.manux.module.system.api.dept.DeptApi;
import top.hondaman.manux.module.system.api.dept.dto.DeptRespDTO;
...
import static top.hondaman.manux.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static top.hondaman.manux.module.bpm.enums.ErrorCodeConstants.*;
import static top.hondaman.manux.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static top.hondaman.manux.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    @DataPermission(enable = false) // 关闭数据权限，避免查询不到用户数据。相关案例：https://gitee.com/zhijiantianya/manux-cloud/issues/ID1UYA
