package top.hondaman.manux.module.ai.service.chat;
...
import top.hondaman.manux.framework.tenant.core.util.TenantUtils;
import top.hondaman.manux.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import top.hondaman.manux.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import top.hondaman.manux.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import top.hondaman.manux.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import top.hondaman.manux.module.ai.dal.dataobject.chat.AiChatConversationDO;
import top.hondaman.manux.module.ai.dal.dataobject.chat.AiChatMessageDO;
import top.hondaman.manux.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import top.hondaman.manux.module.ai.dal.dataobject.model.AiChatRoleDO;
import top.hondaman.manux.module.ai.dal.dataobject.model.AiModelDO;
import top.hondaman.manux.module.ai.dal.dataobject.model.AiToolDO;
import top.hondaman.manux.module.ai.dal.mysql.chat.AiChatMessageMapper;
import top.hondaman.manux.module.ai.enums.ErrorCodeConstants;
import top.hondaman.manux.module.ai.enums.model.AiPlatformEnum;
import top.hondaman.manux.module.ai.framework.ai.core.webserch.AiWebSearchClient;
import top.hondaman.manux.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import top.hondaman.manux.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import top.hondaman.manux.module.ai.service.knowledge.AiKnowledgeDocumentService;
import top.hondaman.manux.module.ai.service.knowledge.AiKnowledgeSegmentService;
import top.hondaman.manux.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import top.hondaman.manux.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import top.hondaman.manux.module.ai.service.model.AiChatRoleService;
import top.hondaman.manux.module.ai.service.model.AiModelService;
import top.hondaman.manux.module.ai.service.model.AiToolService;
import top.hondaman.manux.module.ai.util.AiUtils;
import top.hondaman.manux.module.ai.util.FileTypeUtils;
...
import static top.hondaman.manux.framework.common.pojo.CommonResult.error;
...
import static top.hondaman.manux.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static top.hondaman.manux.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 manux.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 manux.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
