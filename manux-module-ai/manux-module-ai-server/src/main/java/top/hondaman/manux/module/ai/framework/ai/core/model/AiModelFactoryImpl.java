package top.hondaman.manux.module.ai.framework.ai.core.model;
...
import top.hondaman.manux.framework.common.util.spring.SpringUtils;
import top.hondaman.manux.module.ai.enums.model.AiPlatformEnum;
import top.hondaman.manux.module.ai.framework.ai.config.AiAutoConfiguration;
import top.hondaman.manux.module.ai.framework.ai.config.ManuxAiProperties;
...
import top.hondaman.manux.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import top.hondaman.manux.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            ManuxAiProperties.Midjourney properties = SpringUtil.getBean(ManuxAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(ManuxAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        ManuxAiProperties.DouBao properties = new ManuxAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(ManuxAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        ManuxAiProperties.HunYuan properties = new ManuxAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(ManuxAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        ManuxAiProperties.SiliconFlow properties = new ManuxAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(ManuxAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        ManuxAiProperties.XingHuo properties = new ManuxAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(ManuxAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        ManuxAiProperties.BaiChuan properties = new ManuxAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(ManuxAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        ManuxAiProperties.Gemini properties = SpringUtil.getBean(ManuxAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        ManuxAiProperties.Grok properties = new ManuxAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
